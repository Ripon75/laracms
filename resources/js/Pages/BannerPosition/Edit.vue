...
export default {
    ...
    data() {
        return {
            form: this.$inertia.form({
                _method: 'PUT',
                name: this.bannerPosition.name,
                display_name: this.bannerPosition.display_name,
                status: this.bannerPosition.status,
                description: this.bannerPosition.description,
            })
        }
    },
    ...
    methods: {
        ...
        onUpdate() {
            const routeURL = route('positions.update', this.bannerPosition.id);
